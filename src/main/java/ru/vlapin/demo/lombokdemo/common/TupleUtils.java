...
public class TupleUtils {
  ...
  public <T1, T2, T3, T4, T5, T6, T7, T8> Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> tupleWith(T1 self, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8) {
  ...
  public <T1, T2, T3, T4, T5, T6, R> R applyChecked(Tuple6<? extends T1, ? extends T2, ? extends T3, ? extends T4, ? extends T5, ? extends T6> self,
                                                    CheckedFunction6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? extends R> f) {
    return self.apply(f.unchecked());
  }

  public <T1, T2, T3, T4, T5, T6, T7, R> R applyChecked(Tuple7<? extends T1, ? extends T2, ? extends T3, ? extends T4, ? extends T5, ? extends T6, ? extends T7> self,
                                                        CheckedFunction7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> f) {
    return self.apply(f.unchecked());
  }

  public <T1, T2, T3, T4, T5, T6, T7, T8, R> R applyChecked(Tuple8<? extends T1, ? extends T2, ? extends T3, ? extends T4, ? extends T5, ? extends T6, ? extends T7, ? extends T8> self,
