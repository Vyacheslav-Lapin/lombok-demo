...
public class TupleUtils {
  ...
  public <T> Tuple5<T, T, T, T, T> toTuple5(T self) {
    return Tuple(self, self, self, self, self);
  }

  public <T> Tuple6<T, T, T, T, T, T> toTuple6(T self) {
    return Tuple(self, self, self, self, self, self);
  }

  public <T> Tuple7<T, T, T, T, T, T, T> toTuple7(T self) {
    return Tuple(self, self, self, self, self, self, self);
  }

  public <T> Tuple8<T, T, T, T, T, T, T, T> toTuple8(T self) {
    return Tuple(self, self, self, self, self, self, self, self);
  }
  // endregion
